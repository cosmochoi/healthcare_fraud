...
def fraud_preprocessor(i_flag=0):
	if i_flag == 0:
		...
		label_train_df = pd.read_csv('Data/Train-1542865627584.csv')
		label_test_df = pd.read_csv('Data/Test-1542969243754.csv')
		...
		full_df  = pd.merge(full_df, Train_Label, how = 'inner', on = 'Provider')
